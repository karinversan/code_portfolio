...
title_ru: "Контекстный ранкер для рекомендаций маркетплейса"
summary_ru: "Построил быстрый candidate→rank пайплайн с надежной оценкой и guardrails для высоконагруженного маркетплейса."
tags: ["RecSys", "MLOps"]
stack: ["PyTorch", "Faiss", "Feature Store", "Kafka", "Kubernetes", "Postgres"]
metrics: ["CTR +6.4%", "P95 latency 55ms", "Cost −18% (GPU→CPU)" ]
metrics_ru: ["CTR +6.4%", "P95 задержка 55мс", "Стоимость −18% (GPU→CPU)"]
role: "Lead ML Engineer"
role_ru: "Ведущий ML инженер"
year: 2025
links:
