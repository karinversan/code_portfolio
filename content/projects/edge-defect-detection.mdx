...
title_ru: "Детекция дефектов на edge-устройствах"
summary_ru: "Создал компактную CV-модель и on-device пайплайн для контроля качества в реальном времени при жестких бюджетах по задержке."
tags: ["CV", "MLOps"]
stack: ["PyTorch", "ONNX Runtime", "TensorRT", "Kubernetes", "Prometheus"]
metrics: ["Recall 0.92@0.10 FPR", "Latency 45ms (device)", "Scrap rate −9%" ]
metrics_ru: ["Recall 0.92@0.10 FPR", "Задержка 45мс (устройство)", "Доля брака −9%"]
role: "ML Engineer"
role_ru: "Инженер по машинному обучению"
year: 2023
links:
