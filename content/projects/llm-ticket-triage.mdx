...
title_ru: "LLM-помощник для маршрутизации обращений"
summary_ru: "Спроектировал безопасный NLP-пайплайн для точной маршрутизации обращений при сохранении контроля человеком."
...
metrics_ru: ["Macro-F1 +12%", "Время первого ответа −38%", "Доля галлюцинаций &lt;0.5% (аудит)"]
role: "ML Engineer"
